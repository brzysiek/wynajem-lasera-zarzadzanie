...
1. Nowa strona, np. `/finanse/przychody` (dopasuj do konwencji routingu w repo) — ADMIN-only.
2. Nagłówek „Finanse — Przychody" + segmentowany przełącznik trybu okresu (sekcja 1).
