...
export function SzybkiSmsPanel({ initiallyConfigured }: { initiallyConfigured: boolean }) {
  ...
  async function handleSave(event: FormEvent<HTMLFormElement>) {
    ...
    const { ok, data } = await postJson("/wynajem/api/integrations/szybkisms", { token });
  ...
  async function handleRemove() {
    ...
    const { data } = await postJson("/wynajem/api/integrations/szybkisms");
  ...
  async function handleTest() {
    ...
    const { data } = await postJson("/wynajem/api/integrations/szybkisms/test", {});
