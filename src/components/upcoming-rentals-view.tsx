      ...
      <table className="w-full text-left text-sm">
        <thead className="bg-gray-50 text-xs font-medium text-gray-500">
          <tr>
            ...
            <th className="px-3 py-2">Godzina dostawy</th>
            <th className="px-3 py-2">Godzina odbioru</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-gray-100">
          {rentals.map((rental) => (
            <tr key={rental.id} onClick={() => onOpenEdit(rental)} className="cursor-pointer hover:bg-gray-50">
              ...
              <td className="whitespace-nowrap px-3 py-2 text-gray-700">{rental.deliveryTime || "—"}</td>
              <td className="whitespace-nowrap px-3 py-2 text-gray-700">{rental.pickupTime || "—"}</td>
            </tr>
          ))}
        </tbody>
      </table>
